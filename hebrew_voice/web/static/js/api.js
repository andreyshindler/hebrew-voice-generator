...
const MESSAGES = {
  ...
  admin_required: "הפעולה הזו למנהלים בלבד",
  upload_too_large: "הקובץ גדול מדי",
  unsupported_media:
    "אפשר להעלות תמונות (JPEG, PNG, GIF, WebP), סרטונים (MP4, WebM, MOV) ואודיו (MP3, M4A, WAV, OGG)",
  ...
  unsupported_size: "גודל הפריים אינו נתמך",
  too_long_to_render: "ההקלטה ארוכה מדי ליצירת וידאו",
  cues_unavailable: "להקלטה הזו אין תזמוני מילים",
  transcription_disabled: "תמלול אינו זמין בשרת הזה",
  unsupported_for_transcription: "אי אפשר לתמלל את סוג הקובץ הזה. העלו MP3, M4A, WAV, MP4 או WebM",
  recording_too_large: "ההקלטה גדולה מדי לתמלול",
  too_long_to_transcribe: "ההקלטה ארוכה מדי לתמלול",
  transcription_quota_exceeded: "נגמרה מכסת התמלול היומית. היא מתאפסת בחצות",
  already_transcribing: "כבר רץ תמלול אחד. המתינו שיסתיים",
  not_a_transcript: "אפשר לתקן רק הקלטה שתומללה",
  empty_transcript: "התמלול לא יכול להיות ריק",
  transcript_too_long: "התמלול ארוך מדי",
